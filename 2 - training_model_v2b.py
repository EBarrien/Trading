...
fold = 'C:/Users/Stevan/OneDrive/Documentos/Trading/data/'
...
for symbol in symbols:
    df = pd.read_csv(f"{fold}{symbol}_final.csv", index_col=0, parse_dates=True)
    stock_data[symbol] = df

macro_data = pd.read_csv(fold + "macro_final.csv", index_col=0, parse_dates=True)
...
model_file = os.path.join(fold, "trained_drl_model.pth")
